...
public class FavoritosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartelera.setOnClickListener(v -> {
            startActivity(new Intent(FavoritosActivity.this, CarteleraActivity.class));
        });
        Top.setOnClickListener(v -> {
            startActivity(new Intent(FavoritosActivity.this, TopActivity.class));
        });
        searchBar.setOnClickListener(v -> {
            startActivity(new Intent(FavoritosActivity.this, ActivityVaria.class));
        });
